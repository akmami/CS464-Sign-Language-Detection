...
for activation_f in activation_functions:
    print("Execution of ANN training without drop out and with " + activation_f)
    print()
    start = time.time()
    ...
    model = Sequential([Dense(1024, activation=activation_f, kernel_constraint=maxnorm(3), name='Hidden_Layer_1'),
                       ...
                       name='ANN_without_dropout_and_with_' + activation_f)
    ...
    plt.title('Confusion Matrix of ANN model without dropout & with ' + activation_f, fontsize=18)
    plt.show()
...
plt.figure()
plt.title('Training Loss Value for ANN Model without dropout & with ' + activation_functions[0])
plt.xlabel("epoch")
plt.ylabel("loss")
plt.plot(loss_relu)
plt.show()
...
plt.figure()
plt.title('Training Loss Value for ANN Model without dropout & with ' + activation_functions[1])
plt.xlabel("epoch")
plt.ylabel("loss")
plt.plot(loss_prelu)
plt.show()
...
plt.figure()
plt.title('Training Loss Value for ANN Model without dropout & with ' + activation_functions[2])
plt.xlabel("epoch")
plt.ylabel("loss")
plt.plot(loss_sigmo)
plt.show()
...
plt.figure()
plt.title('Validation Loss Value for ANN Model without dropout & with ' + activation_functions[0])
plt.plot(history)
plt.xlabel('epoch')
plt.ylabel('loss')
plt.show()
...
plt.figure()
plt.title('Validation Loss Value for ANN Model without dropout & with ' + activation_functions[1])
plt.plot(history)
plt.xlabel('epoch')
plt.ylabel('loss')
plt.show()
...
plt.figure()
plt.title('Validation Loss Value for ANN Model without dropout & with ' + activation_functions[2])
plt.plot(history)
plt.xlabel('epoch')
plt.ylabel('loss')
plt.show()
...
print('Train time(secs) without dropout ' + activation_functions[0] + ' \t' + str(duration_times[0]))
print('Train time(secs) without dropout ' + activation_functions[1] + ' \t' + str(duration_times[1]))
print('Train time(secs) without dropout ' + activation_functions[2] + ' \t' + str(duration_times[2]))