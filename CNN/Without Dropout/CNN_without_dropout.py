...
for activation_f in activation_functions:
    print("Execution of CNN training without drop out and with " + activation_f)
    print()
    start = time.time()
    CNN = tf.keras.Sequential([keras.layers.Conv2D(filters = number_f_1, kernel_size = kernel_size, input_shape = (28,28,1), name='first_filters'),
                              ...
                              'CNN_without_dropout_and_with_' + activation_f)
    ...
    plt.title('Confusion Matrix of CNN model without dropout & with ' + activation_f, fontsize=18)
    plt.show()
...
plt.figure()
plt.title('Loss Value for CNN Model without dropout & with ' + activation_functions[0])
plt.plot(loss_relu)
plt.xlabel('epoch')
plt.ylabel('loss')
plt.show()
...
plt.figure()
plt.title('Loss Value for CNN Model without dropout & with ' + activation_functions[1])
plt.plot(loss_prelu)
plt.xlabel('epoch')
plt.ylabel('loss')
plt.show()
...
plt.figure()
plt.title('Loss Value for CNN Model without dropout & with ' + activation_functions[2])
plt.plot(loss_sigmo)
plt.xlabel('epoch')
plt.ylabel('loss')
plt.show()
...
plt.figure()
plt.title('Validation Loss Value for CNN Model without dropout & with ' + activation_functions[0])
...
plt.figure()
plt.title('Validation Loss Value for CNN Model without dropout & with ' + activation_functions[1])
plt.plot(val_loss_prelu)
plt.xlabel('epoch')
plt.ylabel('loss')
plt.show()
...
plt.figure()
plt.title('Validation Loss Value for CNN Model without dropout & with ' + activation_functions[2])
plt.plot(val_loss_sigmo)
plt.xlabel('epoch')
plt.ylabel('loss')
plt.show()

plt.plot(val_loss_relu, color='r', label='relu')
plt.plot(val_loss_prelu, color='b', label='prelu')
plt.plot(val_loss_sigmo, color='g', label='sigmoid')
plt.xlabel("epoch")
plt.ylabel("loss")
plt.title("Acitvation functions' losses")
plt.legend()
plt.show()
